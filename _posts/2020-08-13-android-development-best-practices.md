...
1) <b>Choose your App Architecture wisely based on your need, not just what the trend is.</b>
...
2) Consider using <b>SVGs</b> or <b>WebPs</b> for your image drawables
...
3)  Choose your layout wisely and separate out the reusable XML and add it using [<include>](https://developer.android.com/training/improving-layouts/reusing-layouts) tag.
...
11) Handle [Configuration changes](https://developer.android.com/guide/topics/resources/runtime-changes) for your App.
...
16) Implement SSL certificate pinning to prevent [Man-in-the-middle Attack (MITM)](https://ieeexplore.ieee.org/document/4768661/?part=1)
...
17) Use [SafetyNet Attestation API](https://developer.android.com/training/safetynet/attestation) to help determine whether your servers are interacting with your genuine app running on a genuine Android device.
...
18) Use [EncryptedSharedPreferences](https://developer.android.com/reference/androidx/security/crypto/EncryptedSharedPreferences) instead of SharedPreferences for storing sensitive information like your auth tokens etc.

19) Use the [Android Keystore system](https://medium.com/@josiassena/using-the-android-keystore-system-to-store-sensitive-information-3a56175a454b) to store and retrieve sensitive information from your storage like databases etc.
...
21) Implement [reCAPTCHA](https://developer.android.com/training/safetynet/recaptcha) to ensure your app is not automated i.e handled by a robot.
...
22) Write [Unit tests](https://developer.android.com/training/testing/unit-testing) for your feature.
...
24) Learn how to use [Proguard](https://developer.android.com/studio/build/shrink-code) to the maximum for code Obfuscation and Optimization.
...
25) Use [Network security configuration](https://developer.android.com/training/articles/security-config) to improve your app’s network security.
