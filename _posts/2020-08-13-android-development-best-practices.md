...
5) Learn & Use Android Debug Bridge (ADB) to debug your application.<br/><br/>
...
7) Keep a check on structural problems in your App code through Lint.<br/><br/>
...
11) Handle [Configuration changes](https://developer.android.com/guide/topics/resources/runtime-changes) for your App.<br/><br/>
    ...
    There are different options to handle the orientation changes:<br/>
...
13) Don’t create references to activities that will prevent them from being garbage collected when they are done.<br/><br/>
...
14) Use App Chooser for your implicit intents and always handle NoActivityFound Exception.<br/><br/>
...
15) Put all your sensitive information in gradle.properties and never push it to your version control system.<br/><br/>
...
23) Make security decisions on the server-side whenever possible.<br/><br/>
